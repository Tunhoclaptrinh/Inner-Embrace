...
// import "./HomePage.css"; // Đổi tên file CSS
...
//         </h2>
//         <p>Ready? Get in touch with your inner world now...</p>
//         <a href="#" className="cta-btn homepage-btn homepage-btn-primary">
...
//           <a
//             href="#"
//             className="newsletter-btn homepage-btn homepage-btn-primary"
//           >
...
const BodyHomePage = () => {
  ...
  const handleAICoachingClick = () => {
    if (isAuthenticated) {
      // Nếu đã đăng nhập, chuyển hướng đến LoggedInHomePage
      navigate("/logged-in");
    } else {
        ...
        <div className="connection-and-story-container">
          ...
          <div className="ai-connection">
            <div className="ai-connection-content">
              ...
              <button
                onClick={handleAICoachingClick} // Thay đổi từ thẻ <a> sang <button>
                className="ai-connection-btn homepage-btn homepage-btn-primary"
              >
                <div
                  className="pointer-icon"
