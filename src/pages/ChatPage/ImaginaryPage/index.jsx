...
function ImaginaryPage() {
  ...
  // Set mode to "imaginary" on mount
  useEffect(() => {
    setActiveMode("imaginary");
  }, [setActiveMode]);
  ...
  const handleStartChat = async () => {
    if (!localMessages.length && !chatLoading) {
      const result = await createSession("imaginary");
      if (result.success) {
        const systemMessage = {
          id: `system-${Date.now()}`,
          text: "Bạn đang chat với Imaginary Coaching",
          type: "received",
        ...
        <div className="main-chat">
          <div className="header">
            <div className="mode-selector">
              <div className="dropdown-button" title="Imaginary Coaching mode">
                <span className="section-heading">Imaginary Coaching</span>
              </div>
            </div>
